...
genus_plot <- ggplot(data = physq_long, 
       aes(x = study_week, 
           y = abundance, 
           fill = genus)) + 
  geom_col() + 
...
save_plot(filename = "Lab8/figures/Genus_plot.pdf",
          plot = genus_plot, 
          nrow = 1, ncol = 2,
...
order_plot <- ggplot(data = physq_long, 
       aes(x = study_week, #specify the arguments for each axis
           y = abundance, 
...
save_plot(filename = "Lab8/figures/Order_plot.pdf",
          plot = order_plot, 
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1)
```
...
physq_j <- ordinate(physq_sub, 
                      ...
                      k=2, maxit=100, try=50,
                      distance = "jaccard")
physq_j #stress value = 0.2304688
```
...
save_plot(filename = "Lab8/figures/braycurtis_plot.pdf",
          plot = ordplot2, 
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1)
```
...
save_plot(filename = "Lab8/figures/jaccard_plot.pdf",
          plot = ordplot4, 
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1)
```
...
# run test
adn_res <- adonis(formula = dat_jaccard ~ semester * study_week, 
                  data = sampledf)

# view results 
print(adn_res) # The ADONIS test produces low p-values (0.001) and low R-squared values (0.02871 and 0.00774), thus it can be concluded that there is no significant dissimilarity between the groups. 
```
